...
class Contact extends React.Component {
  ...
  handleSubmit(e) {
    ...
    if (this.state.human != "human") {
      ...
      alert(
        "Bot check failed. Please write 'human' (without quotes) in the field just above the submit button, then try again.",
      );
      return;
    }
            ...
            <>
              <div className="form">
                ...
                >
                  ...
                  <br />
                  <label className="formItem">
                    If you are not a robot, then write "human" in this field:
                    <br />
                    <input
                      type="human"
                      name="human"
